...
<div class="recommend" :style='{"border":"1px solid #dfdfdf","boxShadow":"1px 2px 3px #eee","margin":"20px 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","height":"auto","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(img/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat 240px center,url(img/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 760px center"}'>
		<span :style='{"fontSize":"24px","color":"#005aad","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>商品信息推荐</span>
	</div>
...
<div class="recommend" :style='{"border":"1px solid #dfdfdf","boxShadow":"1px 2px 3px #eee","margin":"20px 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"100%","height":"auto","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(img/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat 240px center,url(img/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 760px center"}'>
		<span :style='{"fontSize":"24px","color":"#005aad","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>秒杀商品推荐</span>
	</div>
...
<div class="news" :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"0 0 80px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"49%","height":"660px","order":"2"}'>
	...
	<div class="title" :style='{"width":"100%","margin":"24px 0 24px 0","lineHeight":"1.5","textAlign":"center","background":"url(img/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat -70px bottom,url(img/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 400px bottom"}'>
	...
	<div :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee","margin":"0px 0 20px","overflow":"hidden","borderRadius":"16px","background":"#fff","width":"49%","height":"660px","order":"1"}'>
	  <div :style='{"margin":"12px 0 0 0","color":"#005aad","textAlign":"center","background":"url(img/fc985400d2a2484d8d9e17eb893d2c05.png) no-repeat -70px bottom,url(img/6602c4fb09df4bd4881cabfef19d2ed3.png) no-repeat 400px bottom","width":"100%","lineHeight":"1.5","fontSize":"24px","textShadow":"2px 4px 2px #eee","fontWeight":"bold"}'>{{aboutUsDetail.title}}</div>
